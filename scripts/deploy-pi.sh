...
PI_USER="${RIFFRAP_PI_USER:-pibulus}"
PI_HOST="${RIFFRAP_PI_HOST:-pibulus.local}"
APP_NAME="${RIFFRAP_PI_APP_NAME:-riffrap}"
APP_DIR="${RIFFRAP_PI_APP_DIR:-/home/pibulus/apps/riffrap}"
BACKUP_DIR="${RIFFRAP_PI_BACKUP_DIR:-/home/pibulus/apps-backups}"
STAGING_ROOT="${RIFFRAP_PI_STAGING_ROOT:-/home/pibulus/apps-staging}"
SERVICE="${RIFFRAP_PI_SERVICE:-riffrap}"
SMOKE_HOST="${RIFFRAP_PI_SMOKE_HOST:-127.0.0.1}"
SMOKE_PORT="${RIFFRAP_PI_SMOKE_PORT:-19004}"
LIVE_URL="${RIFFRAP_PI_LIVE_URL:-http://127.0.0.1:9004/}"
APP_ENTRY="${RIFFRAP_PI_APP_ENTRY:-index.js}"
BUILD_TARGET="${RIFFRAP_PI_BUILD_TARGET:-.}"
...
# Secrets/config live in /etc/riffrap.env (systemd EnvironmentFile, root-owned,
...
# app dir .env-free. To change a key: edit ~/.config/fleet/keys.env → keys-sync riffrap.
