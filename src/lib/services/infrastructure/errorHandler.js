...
class ErrorHandlerService {
  constructor() {
    ...
    this.friendlyMessages = {
      ERR_API_KEY:
        "The API key is missing or invalid. Please check your settings.",
      ERR_TRANSCRIPTION:
        "There was a problem processing your audio. Please try again.",
      ERR_NETWORK:
      ...
      ERR_API:
        "There was a problem communicating with the service. Please try again later.",
      ERR_API_BAD_REQUEST:
        "The audio request was invalid. Try recording again.",
      ERR_API_ORIGIN: "This request came from an unexpected origin.",
      ERR_API_PAYLOAD_TOO_LARGE:
