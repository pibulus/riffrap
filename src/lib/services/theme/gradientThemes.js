...
export const purpleTheme = {
  ...
  name: "Purple Haze",
  headerGradient:
    "linear-gradient(to right, #9F7AEA, #B794F4, #D6BCFA, #E9D8FD)",
...
export const oceanTheme = {
  ...
  name: "Ocean Breeze",
  headerGradient:
    "linear-gradient(to right, #4299E1, #63B3ED, #90CDF4, #BEE3F8)",
...
export const forestTheme = {
  ...
  name: "Forest Chill",
  headerGradient:
    "linear-gradient(to right, #48BB78, #68D391, #9AE6B4, #C6F6D5)",
...
export const sunsetTheme = {
  ...
  name: "Simple Sunset",
  headerGradient:
    "linear-gradient(to right, #F9E79F, #F5B041, #E67E22, #E74C3C)",
...
export const allThemes = [purpleTheme, sunsetTheme, oceanTheme, forestTheme];
