...
export const promptTemplates = {
  ...
  standard: {
    transcribeAudio: {
      text: "You are helping a songwriter capture their creative flow. Transcribe this audio as song lyrics, interpreting unclear words and vocal sounds in their most lyrical context. When words are mumbled or unclear, make reasonable creative interpretations that fit the rhythm and emotional tone. Transform rough vocal ideas, humming, and 'gibberish' into coherent lyrical phrases that maintain the original intent and flow. Remove filler words ('um', 'uh', 'like') but preserve the natural vocal rhythm. Format with proper line breaks at natural phrase endings, pauses, and breath marks. Group related lines that share the same thought, mood, or musical phrase into coherent chunks separated by blank lines. Separate different verses, sections, or distinct ideas with blank lines to create clear paragraph-like groupings. This helps users select complete thoughts rather than just individual lines. Focus on capturing the songwriter's creative intent rather than literal accuracy. Return only the formatted lyrics with no additional text."
    },
    generateAnimation: {
