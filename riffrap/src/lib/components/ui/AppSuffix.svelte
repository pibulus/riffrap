<script>
  ...
  // Use a fixed theme (bubblegum looks good and matches the brand)
  const currentTheme = "bubblegum";
  
  // No theme change listener - completely decoupled from theme changes
</script>
